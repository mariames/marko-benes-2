    ...
    <div className="container mx-auto p-4">
      ...
      <div className="md:mb-6 flex justify-end my-1 md:my-14  mr-4 lg:mr-10">
        ...
        <select
          ...
          className="py-7 text-lg border-2 border-gray-700 rounded-md font-bold text-white dark:text-white bg-[#101010] dark:bg-[#101010] tracking-wide focus:outline-none"
        >
      ...
      {filteredServices.map(({ type, images }) => (
        <div key={type} className="mb-12 mx-4 lg:mx-10">
          ...
          {/* ✅ Display Images */}
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 4xl:grid-cols-6 gap-4 2xl:gap-10 3xl:gap-10">
