  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-black">
      <div className="relative w-full">
        ...
        <div className="card-data absolute left-1/2 transform -translate-x-1/2 bottom-[-9rem] w-[680px] bg-gray-100 rounded-xl p-10 shadow-lg opacity-0 transition-all duration-1000">
