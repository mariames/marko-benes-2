  ...
  return (
    <div className="flex justify-center items-center bg-black">
      <div className="relative w-full px-7 4xl:mx-52">
        ...
        <div className="card-data absolute left-1/2 transform -translate-x-1/2 bottom-[-16rem] w-[680px] 2xl:w-[800px] 3xl:w-[900px] 4xl:w-[1800px] 5xl:w-[2800px] bg-gray-50 rounded-xl 4xl:p-24 shadow-lg opacity-95 transition-all duration-1000 ">
