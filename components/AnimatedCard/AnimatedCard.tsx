  ...
  return (
    <div className="flex justify-center items-center bg-black">
      <div className="relative w-full px-7 4xl:mx-52">
        ...
        <div className="card-data absolute left-1/2 transform -translate-x-1/2 bottom-[-9rem] w-[680px] 2xl:w-[800px] 3xl:w-[900px] 4xl:w-[1600px] bg-gray-50 rounded-xl 4xl:p-20 shadow-lg opacity-0 transition-all duration-1000">
          ...
          <p className="text-xl font-medium text-gray-800 mb-2 4xl:text-5xl text-center">
