  ...
  return (
    <section className="bg-black text-white py-16 px-8">
      <div className="max-w-4xl mx-auto text-center">
        <p className="text-gray-300 text-xl christmas-title tracking-wide">
      ...
      <div className="mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 max-w-6xl mx-auto">
        {steps.map((step, index) => (
          <div key={index} className="bg-black border border-gray-100 p-6 rounded-lg">
            <h3 className="text-sm text-gray-400 font-semibold uppercase opacity-75">{step.number} {step.title}</h3>
