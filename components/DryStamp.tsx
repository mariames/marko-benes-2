...
const DryStamp: React.FC = () => {
  return (
    ...
    >
      ...
      <p className="text-lg 2xl:text-2xl text-justify">Dry stamp is a technique of embossing a design into paper or cardboard without using ink or foil, which results in a
