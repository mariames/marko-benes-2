...
const logos = [
  { src: "/logos/Kosili.svg", alt: "Kosili", width: 100, height: 100 },
  ...
  { src: "/logos/Gentlemens-club.svg", alt: "Gentlemen's Club", width: 110, height: 110 },
  ...
  return (
    <div className="bg-black">
        ...
        <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute top-0 bottom-0 left-[34%] w-px bg-gradient-to-b from-transparent via-red-500 to-transparent opacity-0 animate-fadeIn"></div>
            ...
            <div className="absolute top-0 bottom-0 left-[67%] w-px bg-gradient-to-b from-transparent via-red-500 to-transparent opacity-0 animate-fadeIn"></div>
