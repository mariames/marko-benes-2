  ...
  return (
    <div className="bg-black lg:hidden">
      ...
      <div className="flex justify-center items-center max-2xl:min-h-screen relative max-sm:px-3">
        <div className="relative grid grid-cols-4 max-md:grid-cols-3 max-sm:grid-cols-2 gap-x-5 gap-y-2 max-w-5xl 5xl:grid-cols-6 5xl:gap-x-5 5xl:gap-y-3 5xl:max-w-[90rem]">
