  ...
  return (
    <div className="flex flex-col lg:flex-row h-auto lg:h-screen w-full overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 bg-black flex flex-col justify-center px-6 lg:px-16  py-12 lg:py-0">
        ...
        <motion.p 
          className="sm:text-2xl md:text-3xl xl:text-5xl  2xl:text-7xl 3xl:text-8xl 4xl:text-9xl 5xl:text-[140px] font-bold mt-2 text-white tracking-wide"
        ...
        <div className="flex gap-4 mt-6">
          ...
          <motion.a
            href={portfolioLink}
            className="px-1 py-1 lg:px-6 lg:py-3 border border-white rounded-lg text-white"
