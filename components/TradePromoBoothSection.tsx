    ...
    <section className="bg-black text-white py-16 px-6 relative">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="flex items-center space-x-8">
          ...
          >
            <img src="/service-section/PromoBooths/1_promo-trade-booth-stand-fair-design.jpg" alt="Packaging Design" className="w-full h-auto rounded-lg" />
          </motion.div>
          <motion.div
            className="flex-1"
        ...
        <div className="grid grid-cols-2 gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <img src="/service-section/PromoBooths/2_promo-booth-stand-fair-branding-elements.jpg" alt="Packaging Design Example 1" className="w-full h-auto rounded-lg" />
          </motion.div>
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <img src="/service-section/PromoBooths/6_promo-table-design.jpg" alt="Packaging Design Example 2" className="w-full h-auto rounded-lg" />
          </motion.div>
        </div>
